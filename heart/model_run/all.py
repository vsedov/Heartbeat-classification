...
def setup():
    ...
    # {'level_1': {'Normal': <torch.utils.data.dataloader.DataLoader object at 0x7fc08e797a30>}, 'level_2': {'Abnormal': <torch.utils.data.dataloader.DataLoader object
    #
    ...
    ae_data_loader = {
        ...
        for lt, ld in conv_data.items()
        for network in [auto_encoder()]
    }
