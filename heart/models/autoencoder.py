...
class AutoEncoder(DefaultModel):
    ...
    # I will be testing  a new activation function known as ReLU
    # SafeEditText123718cxzDUSAduasCGZXIUcgzIg
    # SafeEditText123718cxzDUSAduasCGZXIUcgzIg
    # Very interesting.
    def __init__(self):
        ...
        self.decoder = nn.Sequential(
            nn.Linear(20, 40), nn.ReLU(), nn.Linear(40, 100), nn.ReLU(), nn.Linear(100, 187), nn.Sigmoid())
